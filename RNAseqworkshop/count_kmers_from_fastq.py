...
from sequence_to_kmer_list import * #will import all (*) methods from this script
...
def main():
	...
	for seq in seq_list :
		...
		all_kmers.extend(kmers) #if you use .append it would make lists within a larger list; so extend will just add the lists together	
